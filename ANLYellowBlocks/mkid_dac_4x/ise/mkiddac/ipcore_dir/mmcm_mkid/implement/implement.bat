...
xst -ifn xst.scr
move mmcm_mkid_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mmcm_mkid_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mmcm_mkid_exdes.ucf mmcm_mkid_exdes

echo 'Running map'
map -timing -pr b mmcm_mkid_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm mmcm_mkid_exdes -w routed.ncd routed.v
cd ..
