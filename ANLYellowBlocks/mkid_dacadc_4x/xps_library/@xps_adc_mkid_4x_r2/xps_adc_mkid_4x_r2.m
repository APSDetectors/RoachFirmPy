...
ext_ports.DI_p         = {12 'in' ['adcmkid','1','_DI_p']         ['{',s.hw_sys,'.zdok','1','_p{[17 37 7 27 26 36 25 35 16 15 6 5],:}}'] 'vector=true'   struct()        ucf_constraints_term};
ext_ports.DI_n         = {12 'in' ['adcmkid','1','_DI_n']         ['{',s.hw_sys,'.zdok','1','_n{[17 37 7 27 26 36 25 35 16 15 6 5],:}}'] 'vector=true'   struct()        ucf_constraints_term};
