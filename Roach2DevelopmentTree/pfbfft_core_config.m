...
function pfbfft_core_config(this_block)
  ...
  this_block.setEntityName('pfbfft_core');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol1').width ~= 24);
      this_block.setError('Input data type for port "pol1" must have width=24.');
    end

    if (this_block.port('pol2').width ~= 24);
      this_block.setError('Input data type for port "pol2" must have width=24.');
    end

    if (this_block.port('pol3').width ~= 24);
      this_block.setError('Input data type for port "pol3" must have width=24.');
    end

    if (this_block.port('pol4').width ~= 24);
      this_block.setError('Input data type for port "pol4" must have width=24.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('pfbfft_core.vhd');
