...
class sramLut:
    ...
    def setLutFreqs(self,freqs,amp,is_prog = True,is_start = True):
		...
		self.lut_q=self.lut_q + self.singleFreqLUT(freq+self.Q_freq_offset, 'Q', self.dac_clk,self.lut_length , phase + self.Q_phase_offs, self.amplist[k]*self.Q_amp_factor)
